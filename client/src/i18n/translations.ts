export const translations = {
  en: {
    ...
    modifyQuantityFor: "Modify the quantity for",
    ...
    enterReasonForAdjustment: "Enter reason for quantity adjustment...",
    cancel: "Cancel",
    adjustQuantity: "Adjust Quantity",
    quantity: "Quantity",
    actions: "Actions",
    clearFilters: "Clear Filters",
    expenses: "Expenses",
    expenseDescription: "Manage your company's fixed expenses and track payments",
    ...
    creating: "Creating...",
    filters: "Filters",
    filterByServiceBeneficiary: "Filter by Service/Beneficiary",
    searchServicesOrBeneficiaries: "Search services or beneficiaries...",
    dateRangeNextPayment: "Date Range (Next Payment)",
    selectDateRange: "Select date range",
    allTime: "All Time",
    lastWeek: "Last Week",
    lastMonth: "Last Month",
    ...
    markedAsPaidSuccess: "Expense marked as paid successfully",
  ...
  fr: {
    ...
    // Stock page specific
    activeStockItems: "Articles de stock actifs",
    currentInventoryValue: "Valeur d'inventaire actuelle",
    ...
    manageInventoryItems: "Gérer vos articles et quantités d'inventaire",
    assignedTo: "Assigné à",
    noStockItemsFound: "Aucun article de stock trouvé",
    ...
    enterReasonForAdjustment: "Entrez la raison de l'ajustement de quantité...",
    cancel: "Annuler",
    adjustQuantity: "Ajuster la quantité",
    quantity: "Quantité",
    actions: "Actions",
    clearFilters: "Effacer les filtres",
    expenses: "Dépenses",
    expenseDescription: "Gérez les dépenses fixes de votre entreprise et suivez les paiements",
    ...
    creating: "Création...",
    filters: "Filtres",
    filterByServiceBeneficiary: "Filtrer par service/bénéficiaire",
    searchServicesOrBeneficiaries: "Rechercher des services ou bénéficiaires...",
    dateRangeNextPayment: "Plage de dates (prochain paiement)",
    selectDateRange: "Sélectionner la plage de dates",
    ...
    markedAsPaidSuccess: "Dépense marquée comme payée avec succès",
  ...
  es: {
    ...
    manageInventoryItems: "Gestionar sus artículos y cantidades de inventario",
    assignedTo: "Asignado a",
    ...
    modifyQuantityFor: "Modificar la cantidad para",
    ...
    enterReasonForAdjustment: "Ingrese la razón del ajuste de cantidad...",
    cancel: "Cancelar",
    adjustQuantity: "Ajustar cantidad",
    quantity: "Cantidad",
    actions: "Acciones",
    clearFilters: "Limpiar filtros",
    expenses: "Gastos",
    expenseDescription: "Gestione los gastos fijos de su empresa y realice seguimiento de pagos",
    ...
    creating: "Creando...",
    filters: "Filtros",
    filterByServiceBeneficiary: "Filtrar por servicio/beneficiario",
    searchServicesOrBeneficiaries: "Buscar servicios o beneficiarios...",
    dateRangeNextPayment: "Rango de fechas (próximo pago)",
    selectDateRange: "Seleccionar rango de fechas",
    allTime: "Todo el tiempo",
    lastWeek: "Última semana",
    lastMonth: "Último mes",
    ...
    markedAsPaidSuccess: "Gasto marcado como pagado exitosamente",
