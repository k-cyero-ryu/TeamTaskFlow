...
export default function StockPage() {
	...
	const [showRecieptCreateDialog, setShowReceiptCreateDialog] = useState(false);
	...
	const handleSubmit = async (data: any) => {
		...
		// TODO: call backend API to create receipt
			...
			<div className="flex items-center justify-between">
				...
				{canManage && (
					<div className="flex items-center gap-2">
						...
						<Dialog open={showRecieptCreateDialog} onOpenChange={setShowReceiptCreateDialog}>
							<DialogTrigger asChild>
								<Button>
									<Plus className="h-4 w-4 mr-2" />
									Add Receipt
